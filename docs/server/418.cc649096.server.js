...
/* harmony export */   "default": () => (/* binding */ fish_tmLanguage),
...
const firstLineMatch = "^#!.*\\bfish\\b";
const foldingStartMarker = "^\\s*(function|while|if|switch|for|begin)\\s.*$";
const foldingStopMarker = "^\\s*end\\s*$";
const keyEquivalent = "^~F";
const name = "fish";
const patterns = [
	{
		begin: "\"",
...
const scopeName = "source.fish";
const uuid = "9CA6DB6F-A16F-4836-A058-617C7378775D";
const fish_tmLanguage = {
	$schema: $schema,
	fileTypes: fileTypes,
