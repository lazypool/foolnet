...
/* harmony export */   "default": () => (/* binding */ plsql_tmLanguage),
...
const foldingStartMarker = "(?i)^\\s*(begin|if|loop)\\b";
const foldingStopMarker = "(?i)^\\s*(end)\\b";
...
const scopeName = "source.plsql.oracle";
const uuid = "28DCE4DD-F5E1-4ED3-8847-64DA6B1F9163";
const plsql_tmLanguage = {
	fileTypes: fileTypes,
