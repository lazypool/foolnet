...
/* harmony export */   "default": () => (/* binding */ vb_tmLanguage),
...
const version = "https://github.com/textmate/asp.vb.net.tmbundle/commit/72d44550b3286d0382d7be0624140cf97857ff69";
const name = "vb";
const scopeName = "source.asp.vb.net";
const comment = "Modified from the original ASP bundle. Originally modified by Thomas Aylott subtleGradient.com";
const patterns = [
	{
		match: "\\n",
