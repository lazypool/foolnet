...
/* harmony export */   "default": () => (/* binding */ dracula$1),
/* harmony export */   dracula: () => (/* binding */ dracula),
/* harmony export */   maintainers: () => (/* binding */ maintainers),
/* harmony export */   name: () => (/* binding */ name),
/* harmony export */   semanticClass: () => (/* binding */ semanticClass),
/* harmony export */   semanticHighlighting: () => (/* binding */ semanticHighlighting),
/* harmony export */   tokenColors: () => (/* binding */ tokenColors)
/* harmony export */ });
const $schema = "vscode://schemas/color-theme";
const name = "dracula";
const author = "Zeno Rocha";
const maintainers = [
	"Derek P Sifford <dereksifford@gmail.com>"
];
const semanticClass = "theme.dracula";
